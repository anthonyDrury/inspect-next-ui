...
// Mobile application Privacy Page
function PrivacyPage(): JSX.Element {
  useEffect((): void => {
    updatePageDescription(`App privacy`, `Mobile application privacy page`);
  });
  return (
    <div style={{ textAlign: "left" }}>
      <Typography variant="h3" component="h1" style={{ textAlign: "center" }}>
        InspectNext IOS/Android Application
      </Typography>
      <p>
        HoneyTech built the InspectNext app as a Free app. This SERVICE is
        provided by HoneyTech at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at InspectNext unless
      ...
      <p>
        ...
        but not limited to location. The information that I request will be
      ...
      <p>
        ...
        hesitate to contact me at admin@inspectnext.com.
      </p>
      <p>
